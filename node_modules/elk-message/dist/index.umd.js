(function (global, factory) {
  ...
  (global = global || self, factory(global.elkMessage = {}));
  ...
  ***************************************************************************** */
  ...
  exports.AlarmByZoneReport = AlarmByZoneReport;
  exports.AlarmByZoneRequest = AlarmByZoneRequest;
  exports.AlarmMemoryUpdate = AlarmMemoryUpdate;
  exports.AlarmReport = AlarmReport;
  exports.AlarmReportAcknowledge = AlarmReportAcknowledge;
  exports.AlarmReportTest = AlarmReportTest;
  exports.AlarmReportTestAcknowledge = AlarmReportTestAcknowledge;
  exports.AlarmState = AlarmState$1;
  exports.AreaArmingStatus = AreaArmingStatus;
  exports.Arm = Arm;
  exports.ArmUpState = ArmUpState$1;
  exports.ArmingLevel = ArmingLevel$1;
  exports.ArmingStatusReport = ArmingStatusReport;
  exports.ArmingStatusRequest = ArmingStatusRequest;
  exports.AudioCommand = AudioCommand$1;
  exports.AudioCommandIncoming = AudioCommandIncoming;
  exports.AudioCommandOutgoing = AudioCommandOutgoing;
  exports.AudioDataReply = AudioDataReply;
  exports.AudioDataRequest = AudioDataRequest;
  exports.BeepAndChimeMode = BeepAndChimeMode$1;
  exports.ChimeMode = ChimeMode$1;
  exports.ControlOutputOff = ControlOutputOff;
  exports.ControlOutputOn = ControlOutputOn;
  exports.ControlOutputStatusReport = ControlOutputStatusReport;
  exports.ControlOutputStatusRequest = ControlOutputStatusRequest;
  exports.ControlOutputToggle = ControlOutputToggle;
  exports.CounterValueRead = CounterValueRead;
  exports.CounterValueReply = CounterValueReply;
  exports.CounterValueWrite = CounterValueWrite;
  exports.CustomNumberValue = CustomNumberValue;
  exports.CustomTimeOfDayValue = CustomTimeOfDayValue;
  exports.CustomValueFormat = CustomValueFormat$1;
  exports.CustomValueRead = CustomValueRead;
  exports.CustomValueReply = CustomValueReply;
  exports.CustomValueWrite = CustomValueWrite;
  exports.CustomValuesReadAll = CustomValuesReadAll;
  exports.DayOfWeek = DayOfWeek$1;
  exports.DisplayTextClearOption = DisplayTextClearOption$1;
  exports.DisplayTextOnScreen = DisplayTextOnScreen;
  exports.ElkCommand = ElkCommand;
  exports.ElkRPConnected = ElkRPConnected;
  exports.ElkResponse = ElkResponse;
  exports.EmailSendTrigger = EmailSendTrigger;
  exports.EntryExitTimer = ExntryExitTimer;
  exports.EthernetModuleReset = EthernetModuleReset;
  exports.EthernetModuleTest = EthernetModuleTest;
  exports.EthernetModuleTestAcknowledge = EthernetModuleTestAcknowledge;
  exports.EventType = EventType$1;
  exports.FunctionKey = FunctionKey$1;
  exports.IlluminationStatus = IlluminationStatus$1;
  exports.InstallerModeExited = InstallerModeExited;
  exports.InsteonLightingDeviceProgramRequest = InsteonLightingDeviceProgramRequest;
  exports.InsteonLightingDeviceProgrammed = InsteonLightingDeviceProgrammed;
  exports.InsteonLightingDeviceStatusReply = InsteonLightingDeviceStatusReply;
  exports.InsteonLightingDeviceStatusRequest = InsteonLightingDeviceStatusRequest;
  exports.KeypadAreaAssigmentsRequest = KeypadAreaAssigmentsRequest;
  exports.KeypadAreaAssignments = KeypadAreaAssignments;
  exports.KeypadFunctionKeyPressReply = KeypadFunctionKeyPressReply;
  exports.KeypadFunctionKeyPressRequest = KeypadFunctionKeyPressRequest;
  exports.KeypadFunctionKeyStatusRequest = KeypadFunctionKeyStatusRequest;
  exports.KeypadKey = KeypadKey$1;
  exports.KeypadKeyChange = KeypadKeyChange;
  exports.LightingDeviceDataReply = LightingDeviceDataReply;
  exports.LightingDeviceStatusRequest = LightingDeviceStatusRequest;
  exports.LogWriteType = LogWriteType$1;
  exports.MonthOfYear = MonthOfYear$1;
  exports.Omnistat2Reply = Omnistat2Reply;
  exports.Omnistat2Request = Omnistat2Request;
  exports.OutputChangeUpdate = OutputChangeUpdate;
  exports.PartyMode = PartyMode$1;
  exports.PlcChangeUpdate = PlcChangeUpdate;
  exports.PlcDeviceControl = PlcDeviceControl;
  exports.PlcDeviceOff = PlcDeviceOff;
  exports.PlcDeviceOn = PlcDeviceOn;
  exports.PlcDeviceStatusReply = PlcDeviceStatusReply;
  exports.PlcDeviceStatusRequest = PlcDeviceStatusRequest;
  exports.PlcDeviceToggle = PlcDeviceToggle;
  exports.PlcFunctionCode = PlcFunctionCode$1;
  exports.RealTimeClockDataReply = RealTimeClockDataReply;
  exports.RealTimeClockDataRequest = RealTimeClockDataRequest;
  exports.RealTimeClockDataWrite = RealTimeClockDataWrite;
  exports.SendASCIIStringToIPAddress = SendASCIIStringToIPAddress;
  exports.SpeakPhrase = SpeakPhrase;
  exports.SpeakWord = SpeakWord;
  exports.SystemLogDataReadRequest = SystemLogDataReadRequest;
  exports.SystemLogDataUpdate = SystemLogDataUpdate;
  exports.SystemLogDataWriteRequest = SystemLogDataWriteRequest;
  exports.SystemTroubleStatusReply = SystemTroubleStatusReply;
  exports.SystemTroubleStatusRequest = SystemTroubleStatusRequest;
  exports.SystemTroubleType = SystemTroubleType$1;
  exports.TaskActivation = TaskActivation;
  exports.TaskChangeUpdate = TaskChangeUpdate;
  exports.TemperatureData = TemperatureData;
  exports.TemperatureDataRequest = TemperatureDataRequest;
  exports.TemperatureDeviceType = TemperatureDeviceType$1;
  exports.TemperatureReply = TemperatureReply;
  exports.TemperatureRequest = TemperatureRequest;
  exports.TextDescriptionReply = TextDescriptionReply;
  exports.TextDescriptionRequest = TextDescriptionRequest;
  exports.TextDescriptionType = TextDescriptionType$1;
  exports.ThermostatData = ThermostatData;
  exports.ThermostatDataRequest = ThermostatDataRequest;
  exports.ThermostatMode = ThermostatMode$1;
  exports.ThermostatSet = ThermostatSet;
  exports.ThermostatSetCoolSetPoint = ThermostatSetCoolSetPoint;
  exports.ThermostatSetFan = ThermostatSetFan;
  exports.ThermostatSetHeatSetPoint = ThermostatSetHeatSetPoint;
  exports.ThermostatSetHold = ThermostatSetHold;
  exports.ThermostatSetMode = ThermostatSetMode;
  exports.ThermostatSetType = ThermostatSetType$1;
  exports.UnknownElkResponse = UnknownElkResponse;
  exports.UserCode = UserCode;
  exports.UserCodeAreasReply = UserCodeAreasReply;
  exports.UserCodeAreasRequest = UserCodeAreasRequest;
  exports.UserCodeChangeReply = UserCodeChangeReply;
  exports.UserCodeChangeRequest = UserCodeChangeRequest;
  exports.UserCodeChangeType = UserCodeChangeType$1;
  exports.UserCodeEntry = UserCodeEntry;
  exports.UserCodeType = UserCodeType$1;
  exports.VersionNumberReply = VersionNumberReply;
  exports.VersionNumberRequest = VersionNumberRequest;
  exports.ZoneBypassReply = ZoneBypassReply;
  exports.ZoneBypassRequest = ZoneBypassRequest;
  exports.ZoneChangeUpdate = ZoneChangeUpdate;
  exports.ZoneDefinition = ZoneDefinition$1;
  exports.ZoneDefinitionData = ZoneDefinitionData;
  exports.ZoneDefinitionRequest = ZoneDefinitionRequest;
  exports.ZoneLogicalState = ZoneLogicalState$1;
  exports.ZonePartitionReport = ZonePartitionReport;
  exports.ZonePartitionRequest = ZonePartitionRequest;
  exports.ZonePhysicalState = ZonePhysicalState$1;
  exports.ZoneStatus = ZoneStatus;
  exports.ZoneStatusReport = ZoneStatusReport;
  exports.ZoneStatusRequest = ZoneStatusRequest;
  exports.ZoneTrigger = ZoneTrigger;
  exports.ZoneVoltageData = ZoneVoltageData;
  exports.ZoneVoltageRequest = ZoneVoltageRequest;
  exports.parse = parse;
