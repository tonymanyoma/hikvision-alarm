(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('events'), require('tls'), require('net'), require('dgram')) :
    typeof define === 'function' && define.amd ? define(['exports', 'events', 'tls', 'net', 'dgram'], factory) :
    (global = global || self, factory(global.elkClient = {}, global.events, global.tls, global.net, global.dgram));
}(this, (function (exports, events, tls, net, dgram) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function createSecureSocket(options) {
        return tls.connect(options.port, options.host, __assign({ rejectUnauthorized: false, secureProtocol: 'TLSv1_method' }, options.secureOptions));
    }
    ...
    exports.ConnectCancelledError = ConnectCancelledError;
    exports.ElkClient = ElkClient;
    exports.ElkClientState = ElkClientState$1;
    exports.ElkConnectionState = ElkConnectionState$1;
    exports.ElkDeviceType = ElkDeviceType$1;
    exports.ElkDiscoveryClient = ElkDiscoveryClient;
    exports.ElkSocketConnection = ElkSocketConnection;
    exports.NotConnectableError = NotConnectableError;
